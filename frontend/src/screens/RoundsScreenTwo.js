...
function RoundsScreen() {
    ...
    // This function renders what courses have been played and has a counter to see how many times the user has played this specific course
                ...
                {newCoursesArr.map(golfCourse => (
                    <Row key={golfCourse.course_id}>
                        <Card style={{ width: '20rem', marginTop:'3rem', marginBottom: '3rem'}}>
                            ...
                            <Button style={{width: '10rem', marginBottom: '1rem'}} onClick={handleShowRounds}> Show Rounds</Button>
                        </Card>                                    
                    </Row>
                ))}          
    ...
    // This Function handles the click event and shows all of the rounds the user has played
