...
export default function FriendListTable({ thArray, tdArray, tdArryTwo, tdAttributes, dataPointUrl, topHeader, buttonText, searchBarChange, handleActions, idName, handleButtonClick }) {
  ...
  return (         
    <div className='table-style-one-container'>
        <div className='table-style-one-top-header'>
            <div>
                <form>
                    <input className='table-style-one-search-bar' placeholder= 'Search My Friends' />
                </form>
            </div>
            <div>
